...
def main():
    ...
    if opts['model'] == 'BetaVAE':
        ...
        # Penalty
        lmba0 = [1, 50, 100, 250, 500, 750, 1000, 1500, 1750, 2000]
        lmba1 = [0.1, 1, 5, 10, 20, 50, 100, 250, 500, 1000]
    ...
    opts['evaluate_every'] = int(opts['epoch_num'] / 5.) * int(data.num_points/opts['batch_size'])-1
